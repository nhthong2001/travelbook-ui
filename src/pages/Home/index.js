...
function Home() {
    return (
        <div className="justify-center grid">
            <div className="w-[65rem] h-[40rem]  mt-4 mb-4 bg-yellow-50 rounded-xl">
                <div className="h-full border-2 border-gray-200 rounded-lg">
                    ...
                    <div className="p-4">
                        ...
                        <h1 className="title-font text-xl font-medium text-gray-900 mb-12">Tên của địa điểm du lịch</h1>
                        <div className="text-lg flex items-center flex-wrap ">
                            <a href="/detail/1" className="text-green-800  md:mb-2 lg:mb-0">
